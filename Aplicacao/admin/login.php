                ...
                <form class="cor-borda">
                    ...
                    <div class="form-row justify-content-center" >
                        <div class="form-group col-10">
                            ...
                            <input class="form-control" id="usuario" type="text" placeholder="seu nome de usario" required>
                        </div> 
                    </div>
                    <div class="form-row justify-content-center">
                        <div class="form-group col-10">
                            <label for="senha">Senha</label>
                            <input class="form-control" id="senha" type="password" placeholder="sua senha" required>
                        </div>                        
                    </div>
                    <div class="form-row justify-content-center my-1">
                        <div class="form-group col-10">
                            <input class="btn cor-verde " type="submit" value="Acessar">
                        </div>
                    </div>
