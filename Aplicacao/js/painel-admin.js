...
requisitarAjax('GET','../model/estatisticaDAO.php?accao=true&&n=1','v2');
setInterval(function(){requisitarAjax("GET","../model/estatisticaDAO.php?accao=true&&n=2","v2");},5000);

requisitarAjax('GET','../model/estatisticaDAO.php?accao=true&&n=1','v3');
...
setInterval(function(){requisitarAjax("GET","../model/estatisticaDAO.php?accao=true&&n=1","v4");},5000);

requisitarAjax('GET','../model/estatisticaDAO.php?accao=true&&n=5','v5');
setInterval(function(){requisitarAjax("GET","../model/estatisticaDAO.php?accao=true&&n=1","v5");},5000);
...
requisitarAjax('GET','../model/estatisticaDAO.php?accao=true&&n=6','v7');
setInterval(function(){requisitarAjax("GET","../model/estatisticaDAO.php?accao=true&&n=7","v7");},5000);

requisitarAjax('GET','../model/estatisticaDAO.php?accao=true&&n=6','v8');
setInterval(function(){requisitarAjax("GET","../model/estatisticaDAO.php?accao=true&&n=6","v8");},5000);
