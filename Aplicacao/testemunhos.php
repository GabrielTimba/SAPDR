...
<body>
    ...
    <header class="container-fluid navbar-expand-sm mb-5">
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <p id="dir"><a href="index.php"><i class="fas fa-home mr-1"></i>Inicio</a> > Publicações > <span class="texto-verde">Testemunhos</span></p>
                    <hr class="cor-verde">
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
				<nav id="navbarVertical" class="navbar navbar-light bg-light nav-artigos">
					<nav class="nav nav-pills flex-column ">						
						<a class="nav-link" href="#test-1">Testemunho 1</a>				
						<a class="nav-link" href="#test-2">Testemunho 2</a>
                        <a class="nav-link" href="#test-3">Testemunho 3</a>
					</nav>
				</nav>	
			</div>
